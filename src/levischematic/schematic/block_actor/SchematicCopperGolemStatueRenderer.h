...
#include "mc/client/renderer/blockactor/CopperGolemStatueRenderer.h"

namespace levischematic::schematic::block_actor {

class SchematicCopperGolemStatueRenderer : public BaseRenderSchematic, public CopperGolemStatueRenderer {
public:
    void
