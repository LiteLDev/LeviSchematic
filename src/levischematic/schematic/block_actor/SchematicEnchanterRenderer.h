...
#include "mc/client/renderer/blockactor/EnchantingTableRenderer.h"

namespace levischematic::schematic::block_actor {

class SchematicEnchanterRenderer : public BaseRenderSchematic, public EnchantingTableRenderer {
public:
    void
