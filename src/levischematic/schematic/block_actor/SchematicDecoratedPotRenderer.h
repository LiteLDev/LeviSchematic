...
#include "mc/client/renderer/blockactor/DecoratedPotRenderer.h"

namespace levischematic::schematic::block_actor {

class SchematicDecoratedPotRenderer : public BaseRenderSchematic, public DecoratedPotRenderer {
public:
    void
