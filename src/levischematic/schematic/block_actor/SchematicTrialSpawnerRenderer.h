...
#include "mc/client/renderer/blockactor/TrialSpawnerBlockRenderer.h"

namespace levischematic::schematic::block_actor {

class SchematicTrialSpawnerRenderer : public BaseRenderSchematic, public TrialSpawnerBlockRenderer {
public:
    void
